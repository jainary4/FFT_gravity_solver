...
#define N_STARS      20000000      // 20 million stars
#define N_DM         80000000      // 80 million dark matter
#define N_BH         10            // 10 black holes
#define N_TOTAL      (N_STARS + N_DM + N_BH)

// Box and grid
#define L            100.0         // Box size (kpc)
#define NMESH        256          // Physical grid (before padding)
#define NMESH_PADDED 512           // After zero-padding
