...
#define N_STARS      200000      // 20 million stars if possible
#define N_DM         800000      // 80 million dark matter if possible
#define N_BH         10            // 10 black holes
#define N_TOTAL      (N_STARS + N_DM + N_BH)

// Box and grid
#define L            10.0      // Box size (kpc)
#define NMESH        128        // Physical grid (before padding)
#define NMESH_PADDED 256       // After zero-padding
